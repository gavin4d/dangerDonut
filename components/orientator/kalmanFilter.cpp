...
void kalmanFilter::predict() {
    ...
    estimateState.variance_A += pow(deltaTime, 2)*estimateState.variance_AV + 0.25*pow(deltaTime, 4)*estimateState.variance_AA;
...
void kalmanFilter::update() {
    ...
    //double K_AA = estimateState.variance_AA / (estimateState.variance_AA + measurmentState.variance_AV/deltaTime);
