...
void uni_bt_bredr_scan_start(void) {
    ...
    status = gap_inquiry_periodic_start(uni_bt_get_gap_inquiry_lenght(), uni_bt_get_gap_max_periodic_length(),
...
void uni_bt_bredr_setup(void) {
    ...
    logi("Periodic Inquiry: max=%d, min=%d, len=%d\n", uni_bt_get_gap_max_periodic_length(),
         uni_bt_get_gap_min_periodic_length(), uni_bt_get_gap_inquiry_lenght());
}
